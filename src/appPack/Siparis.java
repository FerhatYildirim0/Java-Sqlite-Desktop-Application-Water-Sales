...
public Siparis(String name,String surname,String address){
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(100, 240, 60, 20);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setText("Soyadı");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(96, 280, 70, 17);

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setText("Adres");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(96, 320, 70, 17);

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setText("Tutar");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(96, 360, 70, 17);
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/SiparisEkleme.png"))); // NOI18N
